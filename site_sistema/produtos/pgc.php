...
$consulta=mysql_query("SELECT * FROM produtos WHERE subcategoria = 'Palm/GPS/Calculadora'");
?>
<!DOCTYPE html>
<html lang="en">
<head>
<title>::. PALM/GPS/CALCULADORA - Busca da Hora - O seu site de buscas em S&atilde;o Paulo .::</title>
...
<div class="wrap">
   ...
   <div class="container">
      ...
      <section id="content">
         <div class="inside">
           <h2>PALM/<span>GPS</span>/CALCULADORA</h2><br>
