...
$consulta=mysql_query("SELECT * FROM produtos WHERE subcategoria = 'Projetores'");
?>
<!DOCTYPE html>
<html lang="en">
<head>
<title>::. PROJETORES - Busca da Hora - O seu site de buscas em S&atilde;o Paulo .::</title>
...
<div class="wrap">
   ...
   <div class="container">
      ...
      <section id="content">
         <div class="inside">
           <h2>PROJE<span>TORES</span></h2><br>
