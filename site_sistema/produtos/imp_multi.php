...
$consulta=mysql_query("SELECT * FROM produtos WHERE subcategoria = 'Multifuncional'");
?>
<!DOCTYPE html>
<html lang="en">
<head>
<title>::. MULTIFUNCIONAL - Busca da Hora - O seu site de buscas em S&atilde;o Paulo .::</title>
...
<div class="wrap">
   ...
   <div class="container">
      ...
      <section id="content">
         <div class="inside">
           <h2>MULTIFU<span>NCIONAL</span></h2>
    <br>
