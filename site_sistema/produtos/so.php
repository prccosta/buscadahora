...
$consulta=mysql_query("SELECT * FROM produtos WHERE subcategoria = 'SISTEMAS OPERACIONAIS'");
?>
<!DOCTYPE html>
<html lang="en">
<head>
<title>::. SISTEMAS OPERACIONAIS - Busca da Hora - O seu site de buscas em S&atilde;o Paulo .::</title>
...
<div class="wrap">
   ...
   <div class="container">
      ...
      <section id="content">
         <div class="inside">
           <h2>SISTEMAS <span>OPERACIONAIS</span></h2>
     <br>
