...
$consulta=mysql_query("SELECT * FROM produtos WHERE subcategoria = 'ESTABILIZADORES'");
?>
<!DOCTYPE html>
<html lang="en">
<head>
<title>::. ESTABILIZADORES - Busca da Hora - O seu site de buscas em S&atilde;o Paulo .::</title>
...
<div class="wrap">
   ...
   <div class="container">
      ...
      <section id="content">
         <div class="inside">
           <h2>ESTABI<span>LIZADORES</span></h2>
   <br>
