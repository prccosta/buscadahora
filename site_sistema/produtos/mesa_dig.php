...
$consulta=mysql_query("SELECT * FROM produtos WHERE subcategoria = 'MESA DIGITALIZADORA'");
?>
<!DOCTYPE html>
<html lang="en">
<head>
<title>::. MESA DIGITALIZADORA - Busca da Hora - O seu site de buscas em S&atilde;o Paulo .::</title>
...
<div class="wrap">
   ...
   <div class="container">
      ...
      <section id="content">
         <div class="inside">
           <h2>MESA <span>DIGITALIZADORA</span></h2>
      <br>
