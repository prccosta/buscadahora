...
$consulta=mysql_query("SELECT * FROM produtos WHERE subcategoria = 'PROGRAMAÇÃO'");
?>
<!DOCTYPE html>
<html lang="en">
<head>
<title>::. PROGRAMA&Ccedil;&Atilde;O - Busca da Hora - O seu site de buscas em S&atilde;o Paulo .::</title>
...
<div class="wrap">
   ...
   <div class="container">
      ...
      <section id="content">
         <div class="inside">
           <h2>PROGRA<span>MA&Ccedil;&Atilde;O</span></h2>
    <br>
