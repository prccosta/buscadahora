...
$consulta=mysql_query("SELECT * FROM produtos WHERE subcategoria = 'GABINETES/GAVETAS'");
?>
<!DOCTYPE html>
<html lang="en">
<head>
<title>::. GABINETES/GAVETAS - Busca da Hora - O seu site de buscas em S&atilde;o Paulo .::</title>
...
<div class="wrap">
   ...
   <div class="container">
      ...
      <section id="content">
         <div class="inside">
           <h2>GABINETES<span>/GAVETAS</span></h2>
   <br>
