...
$consulta=mysql_query("SELECT * FROM produtos WHERE subcategoria = 'Caixa de Som'");
?>
<!DOCTYPE html>
<html lang="en">
<head>
<title>::. CAIXA DE SOM - Busca da Hora - O seu site de buscas em S&atilde;o Paulo .::</title>
...
<div class="wrap">
   ...
   <div class="container">
      ...
      <section id="content">
         <div class="inside">
           <h2>CAIXA DE <span>SOM</span></h2><br>
