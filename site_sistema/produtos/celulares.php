...
$consulta=mysql_query("SELECT * FROM produtos WHERE subcategoria = 'Celular/Smartphone/Rádio'");
?>
<!DOCTYPE html>
<html lang="en">
<head>
<title>::. CELULAR/SMARTPHONE/RÁDIO - Busca da Hora - O seu site de buscas em S&atilde;o Paulo .::</title>
...
<div class="wrap">
   ...
   <div class="container">
      ...
      <section id="content">
         <div class="inside">
           <h2>CELULAR/<span>SMARTPHONE</span>/R&Aacute;DIO</h2><br>
