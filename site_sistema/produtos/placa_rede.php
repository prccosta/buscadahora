...
$consulta=mysql_query("SELECT * FROM produtos WHERE subcategoria = 'Placa de Rede'");
?>
<!DOCTYPE html>
<html lang="en">
<head>
<title>::. PLACA DE REDE - Busca da Hora - O seu site de buscas em S&atilde;o Paulo .::</title>
...
<div class="wrap">
   ...
   <div class="container">
      ...
      <section id="content">
         <div class="inside">
           <h2>PLACA DE <span>REDE</span></h2><br>
