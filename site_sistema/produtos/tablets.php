...
$consulta=mysql_query("SELECT * FROM produtos WHERE subcategoria = 'Tablets/Ipad'");
?>
<!DOCTYPE html>
<html lang="en">
<head>
<title>::. TABLETS/IPAD - Busca da Hora - O seu site de buscas em S&atilde;o Paulo .::</title>
...
<div class="wrap">
   ...
   <div class="container">
      ...
      <section id="content">
         <div class="inside">
           <h2>TABLETS/<span>IPAD</span></h2><br>
