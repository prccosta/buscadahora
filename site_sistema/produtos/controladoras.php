...
$consulta=mysql_query("SELECT * FROM produtos WHERE subcategoria = 'Controladoras'");
?>
<!DOCTYPE html>
<html lang="en">
<head>
<title>::. CONTRALODORAS - Busca da Hora - O seu site de buscas em S&atilde;o Paulo .::</title>
...
<div class="wrap">
   ...
   <div class="container">
      ...
      <section id="content">
         <div class="inside">
           <h2>CONTRO<span>LADORAS</span></h2><br>
