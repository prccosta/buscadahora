...
$consulta=mysql_query("SELECT * FROM produtos WHERE subcategoria = 'Cabeamento e Afins'");
?>
<!DOCTYPE html>
<html lang="en">
<head>
<title>::. CABEAMENTO E AFINS - Busca da Hora - O seu site de buscas em S&atilde;o Paulo .::</title>
...
<div class="wrap">
   ...
   <div class="container">
      ...
      <section id="content">
         <div class="inside">
           <h2>CABEAMENTO E <span>AFINS</span></h2>
    <br>
