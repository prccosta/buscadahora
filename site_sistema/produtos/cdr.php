...
$consulta=mysql_query("SELECT * FROM produtos WHERE subcategoria = 'CD-R e CD-RW'");
?>
<!DOCTYPE html>
<html lang="en">
<head>
<title>::. CD-R e CD-RW - Busca da Hora - O seu site de buscas em S&atilde;o Paulo .::</title>
...
<div class="wrap">
   ...
   <div class="container">
      ...
      <section id="content">
         <div class="inside">
           <h2>CD-R e <span>CD-RW</span></h2><br>
