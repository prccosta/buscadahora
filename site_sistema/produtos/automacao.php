...
$consulta=mysql_query("SELECT * FROM produtos WHERE subcategoria = 'AUTOMAÇÃO COMERCIAL'");
?>
<!DOCTYPE html>
<html lang="en">
<head>
<title>::. AUTOMA&Ccedil;&Atilde;O COMERCIAL - Busca da Hora - O seu site de buscas em S&atilde;o Paulo .::</title>
...
<div class="wrap">
   ...
   <div class="container">
      ...
      <section id="content">
         <div class="inside">
           <h2>AUTOMA&Ccedil;&Atilde;O <span>COMERCIAL</span></h2>
   <br>
