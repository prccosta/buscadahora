...
$consulta=mysql_query("SELECT * FROM produtos WHERE subcategoria = 'Vídeo-Games - Consoles'");
?>
<!DOCTYPE html>
<html lang="en">
<head>
<title>::. V&Iacute;DEO-GAMES - CONSOLES - Busca da Hora - O seu site de buscas em S&atilde;o Paulo .::</title>
...
<div class="wrap">
   ...
   <div class="container">
      ...
      <section id="content">
         <div class="inside">
           <h2>V&Iacute;DEO-GAMES - <span>CONSOLES</span></h2>
          <br>
