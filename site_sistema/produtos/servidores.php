...
$consulta=mysql_query("SELECT * FROM produtos WHERE subcategoria = 'Servidores'");
?>
<!DOCTYPE html>
<html lang="en">
<head>
<title>::. SERVIDORES - Busca da Hora - O seu site de buscas em S&atilde;o Paulo .::</title>
...
<div class="wrap">
   ...
   <div class="container">
      ...
      <section id="content">
         <div class="inside">
           <h2>SERV<span>IDORES</span></h2><br>
