...
$consulta=mysql_query("SELECT * FROM produtos WHERE subcategoria = 'Processador'");
?>
<!DOCTYPE html>
<html lang="en">
<head>
<title>::. PROCESSADOR - Busca da Hora - O seu site de buscas em S&atilde;o Paulo .::</title>
...
<div class="wrap">
   ...
   <div class="container">
      ...
      <section id="content">
         <div class="inside">
           <h2>PROCE<span>SSADOR</span></h2><br>
