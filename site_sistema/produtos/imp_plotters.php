...
$consulta=mysql_query("SELECT * FROM produtos WHERE subcategoria = 'Plotters e Outras'");
?>
<!DOCTYPE html>
<html lang="en">
<head>
<title>::. PLOTTERS e OUTRAS - Busca da Hora - O seu site de buscas em S&atilde;o Paulo .::</title>
...
<div class="wrap">
   ...
   <div class="container">
      ...
      <section id="content">
         <div class="inside">
           <h2>PLOTTERS E <span>OUTRAS</span></h2>
<br>
