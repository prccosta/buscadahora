...
$consulta=mysql_query("SELECT * FROM produtos WHERE subcategoria = 'Carregadores e Pilhas'");
?>
<!DOCTYPE html>
<html lang="en">
<head>
<title>::. CARREGADORES E PILHAS - Busca da Hora - O seu site de buscas em S&atilde;o Paulo .::</title>
...
<div class="wrap">
   ...
   <div class="container">
      ...
      <section id="content">
         <div class="inside">
           <h2>CARREGADORES E <span>PILHAS</span></h2>
          <br>
