...
$consulta=mysql_query("SELECT * FROM produtos WHERE subcategoria = 'FIBRA ÓPTICA'");
?>
<!DOCTYPE html>
<html lang="en">
<head>
<title>::. FIBRA &Oacute;PTICA - Busca da Hora - O seu site de buscas em S&atilde;o Paulo .::</title>
...
<div class="wrap">
   ...
   <div class="container">
      ...
      <section id="content">
         <div class="inside">
           <h2>FIBRA <span>&Oacute;PTICA</span></h2>
          <br>
