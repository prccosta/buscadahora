...
$consulta=mysql_query("SELECT * FROM produtos WHERE subcategoria = 'HUB/SWITCH'");
?>
<!DOCTYPE html>
<html lang="en">
<head>
<title>::. HUB/SWITCH - Busca da Hora - O seu site de buscas em S&atilde;o Paulo .::</title>
