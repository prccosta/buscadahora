...
$consulta=mysql_query("SELECT * FROM produtos WHERE subcategoria = 'Notebook/Netbook'");
?>
<!DOCTYPE html>
<html lang="en">
<head>
<title>::. NOTEBOOK-NETBOOK - Busca da Hora - O seu site de buscas em S&atilde;o Paulo .::</title>
...
<div class="wrap">
   ...
   <div class="container">
      ...
      <section id="content">
         <div class="inside">
           <h2>NOTEBOOK-<span>NETBOOK</span></h2><br>
