...
<html lang="en">
<head>
<title>::. Sobre - Busca da Hora - O seu site de buscas no Rio de Janeiro .::</title>
...
<div class="wrap">
      ...
      <div class="container">
         ...
         <nav>
            <ul>
               ...
               <li class="current"><a href="sobre.php" class="m2">SOBRE N&Oacute;S</a></li>
   ...
   <div class="container">
      ...
      <section id="content">
         <div class="inside">
            <h2>SOBRE <span>N&Oacute;S</span></h2>
            <div class="img-box"><img src="images/1page-img.jpg">Faça o cadastro conosco e experimente por 30 dias sem custo algum. Saiba mais nessa p&aacute;gina<a href="funciona.php"></a> e aproveite essa promoção de inauguração que é por tempo limitado! Conheça nossos planos e o mais importante! Todos os planos são com cadastro de produtos ilimitados!</div>
            <p class="p0"><span class="txt1">Busca da Hora</span> &eacute; um site de buscas na cidade do Rio de Janeiro e em breve no Brasil inteiro. A id&eacute;ia &eacute; centralizar n&atilde;o todos mas grande parte dos produtos vendidos na cidade do Rio de Janeiro para facilitar a vida do cliente. Aqui voc&ecirc; procura o produto e acha todas as informa&ccedil;&otilde;es sobre ele, pre&ccedil;os e etc.</p>
            <p>Faça logo seu cadastro e usufrua de todos os benefícios dos nossos serviços!</p>
            <ul class="list">
               <li><img src="images/2page-img1.jpg">
                  <h4>Webmaster</h4>
                  <p>Respons&aacute;vel pelo layout e programa&ccedil;&atilde;o do site.</p></li>
            </ul>
         </div>
      </section>
   </div>
