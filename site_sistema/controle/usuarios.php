				  ...
				  <br />
                   			<?php
								...
								{	
										 ...
										 echo '
										 <div id="menu2">
										 <a href="usuarios.php?action=novo"><img border=0 src="images/icones/add.png"> Novo Usuário</a>
										 </div><br />
										 ...
										 <table width="80%" border="0" cellspacing="0" cellpadding="0" id="lista">
											...
											$_pagi_sql = "SELECT id, nome FROM usuarios ORDER BY nome";
											...
											{				
												echo '<tr>
														<td>'. $r['nome'] . '</td>
														<td><a href="usuarios.php?action=editar&id='.$r['id'].'"><img border="0" src="images/icones/editar.jpg"></a></td>
														<td><form action="sql_usuarios.php" method="post" enctype="multipart/form-data"> <input type="hidden" name="apagaruser" value="'.$r['id'].'"><input onClick="return Con()" type="image" src="images/icones/excluirgif.gif"></form></td>
													  </tr>';
											}
								...
								if($_GET['action']=='novo')
								{
									...
									echo '<div id="menu2">
										 		<a href="usuarios.php"><img border=0 src="images/icones/add.png"> Voltar à lista</a>
										  </div><br /><br />
										  
										   <form action="sql_usuarios.php" method="post" enctype="multipart/form-data">
								...
								{	
										...
										$id = $_GET['id'];
										$r = mysql_fetch_array(mysql_query("SELECT nome, login, senha, acesso FROM usuarios WHERE id='$id' LIMIT 1"));
