...
if(isset($_GET["empresa"]))
{
		...
		if(mysql_query($sql))
		{
			...
			echo "<br><br><font color='#ffffff' face='Verdana'><center>A exclusão foi efetuada com sucesso!<br>Clique <a href='constultas.php'>Aqui</a> para voltar para página inicial!</font>";
		}else
		{
