...
$sql=mysql_query("SELECT * FROM usuarios order by login");
	...
	<body>
		...
		<div id="centrar"> 
          <div id="card1">
                    ...
                    <div id="tit">
                    	<p>Relatório de Usuários Administradores (CONTROLE)</p>
                    </div><br>
...
<tr align='center'>
  <td align='center' width='97'><strong>ID</strong></td>
  <td align='center' width='400'><strong>LOGIN</strong></td>
  <td align='center' width='401'><strong>SENHA</strong></td>
  </tr>
</table>";
...
<tr align='center'>
  <td colspan='4'><label>
    <input name='id' style='text-align: center;' type='text' id='id' size='10' maxlength='10' readonly value='".$res['id']."'>
    </label></td>
  <td colspan='4'><label>
    <input name='login' type='text' id='login' size='60' maxlength='60' readonly value='".$res['login']."' class='azul'>
    </label></td>
	  <td colspan='4'><label>
    <input name='senha' type='text' id='senha' size='60' maxlength='60' readonly value='".$res['senha']."' class='azul'></label></td>
	</tr>
</table>";
}
