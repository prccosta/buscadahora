...
<tr align='center'>
  <td colspan='4' align='center' width='10'><strong>ID</strong></td>
	  <td colspan='4' width='150'><strong>NOME DA CATEGORIA</strong></td></tr>
</table>";
while($res=mysql_fetch_array($sql)){
echo "<table align='center' border='1' width='920'>
<tr align='center'>
  <td colspan='4'><label>
    <input name='nome' style='text-align: center;' type='text' id='nome' size='10' maxlength='10' readonly value='".$res['id']."'>
    </label></td>
	  <td colspan='4'><label>
    <input name='nome' type='text' id='nome' size='120' maxlength='120' readonly value='".$res['nome']."' class='azul'>
    </label></td></tr>
</table>";
}
