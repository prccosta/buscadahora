...
$sql=mysql_query("SELECT * FROM produtos WHERE modelo like '%$consulta%'");
?>
<!DOCTYPE html>
<html lang="en">
<head>
<title>::. BUSCA - Busca da Hora - O seu site de buscas em S&atilde;o Paulo .::</title>
...
<div class="wrap">
   ...
   <div class="container">
      ...
      <section id="content">
         <div class="inside">
           <h2>RESULTADO D<span>A BUSCA</span></h2><br>
